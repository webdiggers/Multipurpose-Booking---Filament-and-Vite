    ...
    <div class="bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        ...
        <div class="relative h-[300px] w-full overflow-hidden">
            <div class="absolute inset-0">
                <img src="https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Facility Background" class="h-full w-full object-cover object-center">
                <div class="absolute inset-0 bg-black/60"></div>
            </div>
            <div class="relative h-full flex items-center justify-center text-center" style="padding: 80px 0px">
                <h1 class="text-4xl md:text-6xl font-bold text-white tracking-tight">Get in Touch</h1>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24" style="">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/3 space-y-6">
                    <!-- Phone -->
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 transform hover:-translate-y-1 transition-all duration-300 mb-2">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-indigo-50 dark:bg-indigo-900/50 rounded-xl flex items-center justify-center text-indigo-600 dark:text-indigo-400">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                            </div>
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Call Us</h3>
                                <p class="text-indigo-600 dark:text-indigo-400 font-medium">{{ App\Models\Setting::get('company_phone', '+91 98765 43210') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 transform hover:-translate-y-1 transition-all duration-300 mb-2">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-purple-50 dark:bg-purple-900/50 rounded-xl flex items-center justify-center text-purple-600 dark:text-purple-400">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            </div>
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Email Us</h3>
                                <p class="text-purple-600 dark:text-purple-400 font-medium break-all">{{ App\Models\Setting::get('company_email', 'info@smartersstudio.com') }}</p>
                            </div>
                        </div>
                    </div>

                    <!-- Location -->
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 transform hover:-translate-y-1 transition-all duration-300">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-pink-50 dark:bg-pink-900/50 rounded-xl flex items-center justify-center text-pink-600 dark:text-pink-400">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            </div>
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Visit Us</h3>
                                <p class="text-gray-600 dark:text-gray-300">123 Booking Avenue,<br>Mumbai, MH 400001</p>
                            </div>
                        </div>
                    </div>
                    ...
                    @if(!empty($socialLinks))
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 border border-gray-100 dark:border-gray-700" style="margin: 60px 0px;">
                ...
                <div class="w-full lg:w-2/3">
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 sm:p-12 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
                        <div class="mb-10">
                            <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Send us a Message</h2>
                            <p class="mt-2 text-gray-600 dark:text-gray-300">We usually respond within 24 hours.</p>
                        </div>
